...
class Section extends Db_Crud {
	...
	protected static $update_sql = "UPDATE section SET icon=:icon, title=:title, description=:description, section_name=:section_name, display=:display WHERE section_id = :id ";
